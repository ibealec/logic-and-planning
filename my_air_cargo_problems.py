...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # TODO create concrete Action objects based on the domain action schema for: Load,
        #  Unload, and Fly concrete actions definition: specific literal action that does
        #  not include variables as with the schema for example, the action schema
        ...
        #  concrete because the problems in forward search and Planning Graphs must use
        #  Propositional Logic
